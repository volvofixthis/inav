...
#define TARGET_BOARD_IDENTIFIER "IFSE"
#define USBD_PRODUCT_STRING "IFLIGHT_SucceX_E"
...
#define DEFAULT_FEATURES                                                       \
  (FEATURE_TX_PROF_SEL | FEATURE_OSD | FEATURE_CURRENT_METER | FEATURE_VBAT |  \
   FEATURE_TELEMETRY | FEATURE_BLACKBOX)
